...
cBoard.directive('tmPagination', function ($compile, $templateCache, dataService, chartService) {
    return {
        restrict: 'EA',
        //template: "org/cboard/view/config/modal/tablePagination.html",
        templateUrl: "org/cboard/view/config/modal/tablePagination.html",
        replace: true,
        scope: {
            conf: '='
        },
