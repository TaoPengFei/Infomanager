<%@ page language="java" import="java.util.*,cn.shiyun.entity.User"	pageEncoding="UTF-8"%>
...
%>
<title><spring:message code="empManager"/></title>
...
<link type="text/css" rel="stylesheet"	href="../js/jqgrid/themes/cupertino/jquery-ui.min.css">
...
<script type="text/javascript"	src="../js/jqgrid/themes/cupertino/jquery-ui.min.js"></script>
...
<body>
	...
	<div style="text-align: center; margin: 0 auto;">
		<h3><spring:message code="empManager"/></h3>
	</div>
		...
		<form role="form" id="empinfo-form" AUTOCOMPLETE="off">
			<div class="row">
				...
				<div class="pull-right" style="margin-top: 10xp;">
					<button type="button" class="btn btn-primary" id='queryEmp'><spring:message code="query"/></button>
					<button type="button" class="btn btn-primary" id='addEmp'><spring:message code="add"/></button>
					<button type="button" class="btn btn-primary" id='flagUser'><spring:message code="unenable"/></button>
					<button type="button" class="btn btn-info" id='empreset'><spring:message code="reset"/></button>
				</div>
			</div>
		</form>

		<div class="row" style="margin-top: 10px; margin-bottom: 20px">
			<table id="listEmp"></table>
			<!-- jqGrid 分页 div gridPager -->
			<div id="empPager"></div>
			<p><spring:message code="dbClickChange"/></p>
		</div>
	</div>
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title" id="myModalLabel"><spring:message code="addUser"/></h4>
					</div>
					<div class="modal-body">
						<div class="container">
							<div class="row">
								...
								<div class="col-md-3 column">
									<div class="input-group">
										<span class="input-group-addon"><spring:message code="userRole"/></span> <select
