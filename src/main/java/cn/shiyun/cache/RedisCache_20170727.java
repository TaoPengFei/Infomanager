...
import cn.shiyun.util.SerializeUtil;
...
/**
 * Created by 陶鹏飞 on 2017/7/26.
 */
/*
 * 使用第三方缓存服务器，处理二级缓存
 */
public class RedisCache_20170727 implements Cache {

    private static Logger logger = LoggerFactory.getLogger(RedisCache_20170727.class);
    ...
    public RedisCache_20170727() {

    }

    public RedisCache_20170727(final String id) {
        if (id == null) {
